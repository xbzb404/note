...
#### 第三阶段：配置 MP-BGP 邻居（PE 之间）

**步骤10：建立 IBGP 邻居，使能 VPNv4 地址族**
...
| 阶段     | 步骤  | 核心命令                                                     |
| :------- | :---- | :----------------------------------------------------------- |
| 公网底层 | 1-6   | `mpls lsr-id`、`mpls ldp`、`ospf`、`mpls`、`interface mpls`  |
| VPN 实例 | 7-9   | `ip vpn-instance`、`route-distinguisher`、`vpn-target`、`ip binding vpn-instance`、`ospf vpn-instance` |
| BGP 邻居 | 10    | `bgp`、`peer`、`ipv4-family vpnv4`                           |
