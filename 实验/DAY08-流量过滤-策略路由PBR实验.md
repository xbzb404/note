...
![20250902135641910](DAY08-流量过滤-策略路由PBR实验.assets/20250902135641910.png)

![image-20260620141308420](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620141308420.png)
...
![image-20260620140808600](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620140808600.png)

![image-20260620140824253](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620140824253.png)

额外测试，使用filter-policy让AR1去除100.100.100.0/24 网段的路由，再次测试

未配置时，AR1上有net100的路由

![image-20260620142350828](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620142350828.png)
...
![image-20260620142021830](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620142021830.png)

再次测试，依旧正常ping通，证明策略生效

![image-20260620142445363](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620142445363.png)

![image-20260620142229143](DAY08-流量过滤-策略路由PBR实验.assets/image-20260620142229143.png)
