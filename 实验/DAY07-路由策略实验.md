...
![image-20260615213107003](DAY07-路由策略实验.assets/image-20260615213107003.png)



目标：在OSPF中引入ISIS路由，并剔除掉172.16.0.0/16

![image-20260615233653615](DAY07-路由策略实验.assets/image-20260615233653615.png)
...
![image-20260615235426546](DAY07-路由策略实验.assets/image-20260615235426546.png)

实验结果：如下图所示，应用策略后没有 172.16.0.0/16,已经被过滤掉了

![image-20260615233941451](DAY07-路由策略实验.assets/image-20260615233941451.png)